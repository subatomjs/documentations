...
Generate interactive API documentation with OpenAPI 3.x and Swagger UI from your Subatom routes.
...
```typescript
// src/index.ts
import { Subatom, SubAtomDocs } from "subatom";
...
- **GET /docs/swagger.json** - OpenAPI 3.1.0 specification (if enabled)
